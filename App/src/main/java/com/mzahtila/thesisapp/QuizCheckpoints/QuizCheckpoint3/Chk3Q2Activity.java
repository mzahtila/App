...
public class Chk3Q2Activity extends AppCompatActivity {
    ImageView myExample;
    Toolbar toolbar;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chk3_q2);
    ...
    private void exitDialog() {
        ...
        exitDialog.setPositiveButton("Leave", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int arg) {
                ...
                Intent i = new Intent(Chk3Q2Activity.this, QuizMainActivity.class);
                startActivity(i);
            }
        });
    ...
    */
    public void testAnswers(boolean answer1, boolean answer2, boolean answer3, boolean answer4, boolean answer5) {
        if (answer4 && (!answer1 && !answer2 && !answer3 && !answer5)) {
            answers = true;
        }
        Log.i("Chk3Q2Activity", "Answers: " + answer1 + ", " + answer2 + ", " + answer3 + ", " + answer4);
    }
    ...
    public void onDoneClick(View view) {
        ...
        if (!chkBxAnsw1.isChecked() && !chkBxAnsw2.isChecked() && !chkBxAnsw3.isChecked() && !chkBxAnsw4.isChecked() && !chkBxAnsw5.isChecked()) {
            ...
            if (answers) {
                ...
                i = new Intent(Chk3Q2Activity.this, Chk3Q5Activity.class); // start next question
