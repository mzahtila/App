...
public class Chk1ComprehensionActivity extends AppCompatActivity {
    String  answerChk;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chk1_comprehension);
    ...
    private void exitDialog() {
        ...
        exitDialog.setPositiveButton("Leave", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int arg) {
                ...
                Intent i = new Intent(Chk1ComprehensionActivity.this, QuizMainActivity.class);
                startActivity(i);
            }
        });
    ...
    */
    public void onDoneClick(View view) {
        ...
        if (answered2.equals("")) {
            ...
            int scoredChk = QuizScoreManager.getChkScore(1);
    ...
    /* ---------------------------------------------------------------------------------------------
     * Writing the score and comprehension answer to the database
     */
    private void saveResults(int newScore) {
        ...
        values.put(GroupContract.PLD_CHK1, 1); // 0 - unplayed, 1 - played and finished
        values.put(GroupContract.ANSW_CHK1, answerChk);
    ...
    private void showDoneDialogBox(String answered) {
        ...
        if (answered.equals("answerMissing")) {
            ...
            int scoredAtCheckpoint = QuizScoreManager.getChkScore(1);
