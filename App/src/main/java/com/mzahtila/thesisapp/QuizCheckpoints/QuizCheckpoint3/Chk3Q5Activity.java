...
public class Chk3Q5Activity extends AppCompatActivity {
    ImageView myExample;
    Toolbar toolbar;
    Context context;
    ...
    private RadioButton chkBxAnsw1, chkBxAnsw2, chkBxAnsw3, chkBxAnsw4, chkBxAnsw5, chkBxAnsw6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chk3_q5);
        ...
        chkBxAnsw6 = (RadioButton) findViewById(R.id.answer6);
        setListeners();
    ...
    private void exitDialog() {
        ...
        exitDialog.setPositiveButton("Leave", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int arg) {
                ...
                Intent i = new Intent(Chk3Q5Activity.this, QuizMainActivity.class);
                startActivity(i);
            }
        });
    ...
    */
    public void testAnswers(boolean answer1, boolean answer2, boolean answer3, boolean answer4, boolean answer5, boolean answer6) {
        ...
        if (answer2 && (!answer1 && !answer3 && !answer4 && !answer5 && !answer6)) {
            answers = true;
        }
    ...
    */
    public void onDoneClick(View view) {
        ...
        if (answers) {
            QuizScoreManager.addChkScore(3, tempScore);
            i = new Intent(Chk3Q5Activity.this, Chk3Q3Activity.class); // start next question
