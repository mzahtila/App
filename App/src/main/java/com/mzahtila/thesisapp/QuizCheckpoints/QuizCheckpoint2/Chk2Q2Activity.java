...
public class Chk2Q2Activity extends AppCompatActivity {
    ImageView myExample;
    Toolbar toolbar;
    Context context;
    TextView doneButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chk2_q2);
    ...
    private void exitDialog() {
        ...
        exitDialog.setPositiveButton("Leave", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int arg) {
                ...
                Intent i = new Intent(Chk2Q2Activity.this, QuizMainActivity.class);
                startActivity(i);
            }
        });
    ...
    */
    public void testAnswers(boolean answer1, boolean answer2, boolean answer3, boolean answer4, boolean answer5) {
        ...
        if ((answer1 && answer3 && answer4) && (!answer2 && !answer5)) {
            answers = true;
        }
    ...
    public void onDoneClick(View view) {
        ...
        if (!chkBxAnsw1.isChecked() && !chkBxAnsw2.isChecked() && !chkBxAnsw3.isChecked() && !chkBxAnsw4.isChecked() && !chkBxAnsw5.isChecked()) {
            ...
            if (answers) {
                ...
                i = new Intent(Chk2Q2Activity.this, Chk2Q3Activity.class); // start next question
