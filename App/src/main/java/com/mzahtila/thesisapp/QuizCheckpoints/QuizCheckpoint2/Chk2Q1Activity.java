...
public class Chk2Q1Activity extends AppCompatActivity {
    ImageView myExample;
    Toolbar toolbar;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chk2_q1);
    ...
    private void exitDialog() {
        ...
        exitDialog.setPositiveButton("Leave", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int arg) {
                ...
                Intent i = new Intent(Chk2Q1Activity.this, QuizMainActivity.class);
                startActivity(i);
            }
        });
    ...
    */
    public void testAnswers(boolean answer1, boolean answer2, boolean answer3, boolean answer4, boolean answer5) {
        ...
        //Log.i("Chk2Q1Activity", "Answers: " + answer1 + ", " + answer2 + ", " + answer3 + ", " + answer4 + ", " + answer5 + ", " + answer6 + ", " + answer7);
    }
    ...
    public void onDoneClick(View view) {
        ...
        if (!chkBxAnsw1.isChecked() && !chkBxAnsw2.isChecked() && !chkBxAnsw3.isChecked() && !chkBxAnsw4.isChecked() && !chkBxAnsw5.isChecked()) {
            ...
            if (answers) {
                ...
                i = new Intent(Chk2Q1Activity.this, Chk2Q2Activity.class); // start next question
