...
public class Chk4Q6Activity extends AppCompatActivity {
    ImageView myExample;
    Toolbar toolbar;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chk4_q6);
    ...
    private void exitDialog() {
        ...
        exitDialog.setPositiveButton("Leave", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int arg) {
                ...
                Intent i = new Intent(Chk4Q6Activity.this, QuizMainActivity.class);
                startActivity(i);
            }
        });
    ...
    public void onDoneClick(View view) {
        ...
        if (!chkBxAnsw1.isChecked() && !chkBxAnsw2.isChecked() && !chkBxAnsw3.isChecked() && !chkBxAnsw4.isChecked()) {
            ...
            if (answers) {
                ...
                i = new Intent(Chk4Q6Activity.this, Chk4Q7Activity.class); // start next question
