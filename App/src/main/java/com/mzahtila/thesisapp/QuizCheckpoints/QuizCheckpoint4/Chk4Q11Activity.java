...
public class Chk4Q11Activity extends AppCompatActivity {
    ImageView myExample;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chk4_q11);
    ...
    private void exitDialog() {
        ...
        exitDialog.setPositiveButton("Leave", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int arg) {
                ...
                Intent i = new Intent(Chk4Q11Activity.this, QuizMainActivity.class);
                startActivity(i);
            }
        });
    ...
    */
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (myExample.getVisibility() == View.VISIBLE) {
            myExample.setVisibility(View.INVISIBLE);
            BackgroundHelper.backgroundOnOff(this, this, true, 4);
        } else
            showExample();
    ...
    public void showExample() {
        myExample.setVisibility(View.VISIBLE);
        BackgroundHelper.backgroundOnOff(this, this, false, 4);
    }
    ...
    */
    public void testAnswers(boolean answer1, boolean answer2, boolean answer3, boolean answer4) {
        if ((answer2) && (!answer1 && !answer3 && !answer4)) {
            answers = true;
        }
    }
    ...
    public void onDoneClick(View view) {
        ...
        if (!chkBxAnsw1.isChecked() && !chkBxAnsw2.isChecked() && !chkBxAnsw3.isChecked() && !chkBxAnsw4.isChecked()) {
            ...
            if (answers) {
                ...
                i = new Intent(Chk4Q11Activity.this, Chk4ComprehensionActivity.class); // start next question
