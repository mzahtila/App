...
public class Chk3ComprehensionActivity extends AppCompatActivity {
    String answerChk;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chk3_comprehension);
    ...
    private void saveResults(int newScore) {
        ...
        values.put(GroupContract.PLD_CHK3, 1); // 0 - unplayed, 1 - played and finished
        values.put(GroupContract.ANSW_CHK3, answerChk);
    ...
    private void exitDialog() {
        ...
        exitDialog.setPositiveButton("Leave", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int arg) {
                ...
                Intent i = new Intent(Chk3ComprehensionActivity.this, QuizMainActivity.class);
                startActivity(i);
            }
        });
    ...
    */
    public void onDoneClick(View view) {
        ...
        if (answered2.equals("")) {
            ...
            int scoredChk = QuizScoreManager.getChkScore(3);

            mDbHelper = new QuizDbHelper(this);
            int groupOldScore = mDbHelper.getScore();
            int groupNewScore = groupOldScore + scoredChk;

            //QuizScoreManager.updateMasterScore(scored);
    ...
    private void showDoneDialogBox(String answered) {
        ...
        if (answered.equals("answerMissing")) {
            ...
            int scoredAtCheckpoint = QuizScoreManager.getChkScore(3);
