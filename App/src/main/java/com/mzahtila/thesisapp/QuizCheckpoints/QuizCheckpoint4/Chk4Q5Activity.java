...
public class Chk4Q5Activity extends AppCompatActivity {
    ImageView myExample;
    Context context;

    private int countTrys = 0;
    private int tempScore = 3;
    private RadioButton chkBxAnsw1, chkBxAnsw2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chk4_q5);
    ...
    private void exitDialog() {
        ...
        exitDialog.setPositiveButton("Leave", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int arg) {
                ...
                Intent i = new Intent(Chk4Q5Activity.this, QuizMainActivity.class);
                startActivity(i);
            }
        });
    ...
    */
    public void testAnswers(boolean answer1, boolean answer2) {
        if (answer1 && !answer2) {
            answers = true;
        }
    }
    ...
    public void onDoneClick(View view) {
        ...
        if (!chkBxAnsw1.isChecked() && !chkBxAnsw2.isChecked()) {
            ...
            testAnswers(isChoiceAnswer1, isChoiceAnswer2);

            if (answers) {
                QuizScoreManager.addChkScore(4, tempScore); // updates current score on current checkpoint
                i = new Intent(Chk4Q5Activity.this, Chk4Q6Activity.class); // start next question
