...
public class Chk3Q6Activity extends AppCompatActivity {
    ImageView myExample;
    Toolbar toolbar;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chk3_q6);
    ...
    private void exitDialog() {
        ...
        exitDialog.setPositiveButton("Leave", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int arg) {
                ...
                Intent i = new Intent(Chk3Q6Activity.this, QuizMainActivity.class);
                startActivity(i);
            }
        });
    ...
    */
    public void testAnswers(boolean answer1, boolean answer2, boolean answer3, boolean answer4, boolean answer5) {
        ...
        Log.i("Chk3Q6Activity", "Answers: " + answer1 + ", " + answer2 + ", " + answer3 + ", " + answer4);
    }
    ...
    public void onDoneClick(View view) {
        ...
        if (!chkBxAnsw1.isChecked() && !chkBxAnsw2.isChecked() && !chkBxAnsw3.isChecked() && !chkBxAnsw4.isChecked() && !chkBxAnsw5.isChecked()) {
            ...
            Log.i("Chk3Q6Activity", "Answered correctly: " + answers);

            if (answers) {
                QuizScoreManager.addChkScore(3, tempScore); // updates current score on current checkpoint
                i = new Intent(Chk3Q6Activity.this, Chk3Q7Activity.class); // start next question
